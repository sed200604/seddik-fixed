...
const defaultFaqData: FAQCategory[] = [
  ...
  },
  {
    ...
    questions: [
      { q: "ماذا لو لم يُقبل طلبي؟", a: "نسبة قبولنا 100% حتى الآن. لكن في الحالة النادرة جداً للرفض من قبل الولاية، نقوم باسترداد المبلغ كاملاً لك بدون أي خصومات." }, /* FIXED: استرجاع→استرداد */
